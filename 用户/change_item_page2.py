...
from 用户.success_ci import success_ci
...
class change2_type:
    def __init__(self, master:tk.Tk):
        # 页面布局
        self.root = master
        self.root.title('物品交换系统-用户版-输入修改后信息')
        ...
        self.show_type()
        tk.Button(self.page, text='修改', command=self.add).grid(row=5, column=2,pady=100)
...
#类型一-json1
class change2_type1(change2_type):
    def __init__(self,master:tk.Tk):
...
#类型二-json2
class change2_type2(change2_type):
    def __init__(self, master:tk.Tk):
        super().__init__(master)
...
#类型三-json3
class change2_type3(change2_type):
    def __init__(self, master:tk.Tk):
        super().__init__(master)
...
#类型四-json4
class change2_type4(change2_type):
    def __init__(self, master:tk.Tk):
        super().__init__(master)
...
#类型五-json5
class change2_type5(change2_type):
    def __init__(self, master:tk.Tk):
        super().__init__(master)
